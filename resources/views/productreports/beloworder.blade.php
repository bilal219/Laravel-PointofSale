        ...
        <div class="col-sm-12">
            <div class="container1">
                <center>
                    ...
                    <h3><u> REORDER PRODUCT LIST </u></h3>
                </center>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-body card-outline">
                        <div class="card-body">
                            <div class="table-responsive" id="show_all_fetchreorder">
...
function fetchreorder() {
    $.ajax({
        url: "{{route('fetchreorder')}}",
        method: 'get',
        success: function(res) {
            $('#show_all_fetchreorder').html(res);
            $('#example').DataTable({
                "pageLength": 10,
            });
        }

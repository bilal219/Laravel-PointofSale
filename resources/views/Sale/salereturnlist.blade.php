...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Sales Return List</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                <form id="frm_return_invoice_list">
                                    <div class="d-flex">
                                        <div class="mx-1">
                    ...
                    <div class="card-body">   
                        <div class="table-responsive" id="show_all_salereturnlist">	
...
<script>
    ...
    function getreturnlist(){
        ...
        $.ajax({
            ...
            success:function(res){
                $('#show_all_salereturnlist').html(res);
                $('#SR_lists').DataTable({
                    "pageLength": 5,
                });               
            }
    ...
    $('#frm_return_invoice_list').submit(function(e){
        e.preventDefault();
        getreturnlist();
    })

    //show list
    $(document).on('click','.viewSR_detail',function(){
        let invoice_no=$(this).attr('id');
        returnlistdetail(invoice_no)
    })

    // load returnlist detail
    function returnlistdetail(invoice)
    {
        var invoice_no=invoice
        $.ajax({
            method:'post',
            url:'{{route('salereturndetail')}}',
            data:{
                invoice:invoice_no,
                _token:'{{csrf_token()}}',
            },

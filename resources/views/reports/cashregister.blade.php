                    ...
                    <div class="card card-body card-outline">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <b>Users</b>
                                    <select name="userfilter" id="user" class="tcal form-control select2bs4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{route('cashregister')}}" class="btn btn-warning btn-sm"><i
                                            class="fas fa-redo-alt"></i></a>
                                </div>
                            </div>
                            <br>
                            <div class="table-responsive" id="show_all_fetchcashregister">
...
function fetchcashregister() {
    $.ajax({
        url: "{{route('fetchcashregister')}}",
        method: 'get',
        data: {
            from: $('#from').val(),
            to: $('#to').val(),
        ...
        success: function(res) {
            $('#show_all_fetchcashregister').html(res);
            $('#example').DataTable({
                "pageLength": 10,
            });
        }

                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{route('cashflow')}}" class="btn btn-warning btn-sm"><i
                                            class="fas fa-redo-alt"></i></a>
                                </div>
                            </div>
                            <br>
                            <div class="table-responsive" id="show_all_fetchcashflow">
...
function fetchcashflow() {
    $.ajax({
        ...
        success: function(res) {
            $('#show_all_fetchcashflow').html(res);
            $('#example').DataTable({
                "pageLength": 10,
            });
        }

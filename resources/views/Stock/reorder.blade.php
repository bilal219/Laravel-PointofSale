...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Reorder Products</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Reorder Products</h4>
                            ...
                            <div class="ml-auto">
                                ...
                                <select name="product_category" class="form-control form-control-sm" id="product_category" onchange="loadreorder()">
